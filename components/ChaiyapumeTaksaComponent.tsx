// src/components/ChaiyapumeTaksaComponent.tsx
import React from 'react';
import ThemedSection from './ThemedSection';
import ThemedCard from './ThemedCard';
import { chaiyapumeTaksaData } from '../data/mahataksaData';

const ChaiyapumeTaksaComponent: React.FC = () => {
    ...
    return (
        <ThemedSection title={chaiyapumeTaksaData.name} gridColsClassName="grid-cols-1">
            <ThemedCard className="flex flex-col items-center justify-center p-4">
                <div className="grid grid-cols-3 gap-0 w-full max-w-xs overflow-hidden rounded-md">
                    {gridItems(chaiyapumeTaksaData.numbers, chaiyapumeTaksaData.chaiyapume).map((item, itemIndex) => (
                        <div
                            key={itemIndex}
                            className={`
...
export default ChaiyapumeTaksaComponent;